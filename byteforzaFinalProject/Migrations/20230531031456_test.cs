        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Vaccanies = table.Column<int>(type: "int", nullable: false),
                    Selected = table.Column<int>(type: "int", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Tech1 = table.Column<int>(type: "int", nullable: true),
                    Tech2 = table.Column<int>(type: "int", nullable: true),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_candidatesProcess", x => x.Id);
                    table.ForeignKey(
                        name: "FK_candidatesProcess_candidates_CandidateId",
                        column: x => x.CandidateId,
                        principalTable: "candidates",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_candidatesProcess_jobs_JobId",
                        column: x => x.JobId,
                        principalTable: "jobs",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_candidatesProcess_CandidateId",
                table: "candidatesProcess",
                column: "CandidateId");

            migrationBuilder.CreateIndex(
                name: "IX_candidatesProcess_JobId",
                table: "candidatesProcess",
                column: "JobId");
