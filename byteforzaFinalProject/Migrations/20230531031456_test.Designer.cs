...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("byteforzaFinalProject.DatabaseContext.ApplicationUser", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("byteforzaFinalProject.Models.Candidate", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("byteforzaFinalProject.Models.CandidateProcess", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("byteforzaFinalProject.Models.Interview", b =>
                {
                    ...
                    b.Property<string>("InterviewPanel")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("byteforzaFinalProject.DatabaseContext.ApplicationUser", null)
                        .WithMany()
            ...
            modelBuilder.Entity("byteforzaFinalProject.Models.CandidateProcess", b =>
                {
                    ...
                    b.HasOne("byteforzaFinalProject.Models.Job", null)
                        .WithMany("Child1")
                        .HasForeignKey("JobId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("byteforzaFinalProject.Models.Interview", b =>
                {
                    ...
                    b.HasOne("byteforzaFinalProject.Models.Job", "job")
                        .WithMany("Child2")
                        .HasForeignKey("JobId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
